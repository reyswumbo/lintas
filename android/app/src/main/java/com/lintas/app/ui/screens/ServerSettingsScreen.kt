...
fun ServerSettingsScreen(onBack: () -> Unit) {
    ...
    var url by remember { mutableStateOf(ServerConfig.getBaseUrl(context)) }
    ...
    Scaffold(
        ...
        Column(
            ...
            Text(
                text = "Connect to your backend server",
            ...
            Text(
                text = "Enter the address where the Lintas backend is running.\n\n" +
                    "• Emulator: http://10.0.2.2:8000\n" +
                    "• Physical device (same Wi-Fi): http://<LAN-IP-of-computer>:8000",
            ...
            OutlinedButton(
                onClick = {
                    ...
                    ServerConfig.setBaseUrl(context, Constants.DEFAULT_BASE_URL)
                },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
